...
export default function About() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-8 text-center">About Prime Properties</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="relative w-full h-[400px]">
          {/* <Image
            src="https://source.unsplash.com/random/800x600?realestate,office"
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-4">
            Prime Properties was founded in 2005 with a vision to revolutionize the real estate industry. Our journey began with a small team of passionate individuals who believed in making the dream of homeownership accessible to everyone.
          </p>
          <p className="text-muted-foreground mb-4">
          ...
          <p className="text-muted-foreground">
            At Prime Properties, we don't just sell houses; we help people find homes where memories are made and dreams come true.
          </p>
        </div>
      </div>
          ...
          <Card key={index}>
            ...
            <CardContent>
              <p className="text-center text-muted-foreground">
                With over 10 years of experience, {name.split(' ')[0]} has helped countless families find their perfect homes.
              </p>
            </CardContent>
          </Card>
        ))}
